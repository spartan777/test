...
class Test_private extends CI_Controller {
    ...
    public function index()
    {
    	if ($this->session->userdata('login') == TRUE) {
    		$this->load->view('private/cabeceras');
			$this->load->view('private/menu');
			//$this->load->view('private/aptitudes');
    ...
    public function aptitudes_resultado()
	{
		...
		$this->load->view('private/cabeceras');
		$this->load->view('private/menu');
		$this->load->view('private/aptitudes_resultado', $data );
		$this->load->view('private/footer');
	}
    ...
    public function intereses(){
    	if ($this->session->userdata('login') == TRUE) {
			$this->load->view('private/cabeceras');
			$this->load->view('private/menu');
			$this->load->view('private/intereses');
			$this->load->view('private/footer');
		} 
		else
		{
